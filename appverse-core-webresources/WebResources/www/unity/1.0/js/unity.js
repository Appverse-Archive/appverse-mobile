...
var updateOrientation = function() {
    ...
    /* Not needed now, it is better to throw the orientationchange event
...
/**
 * Provides information about the display given its index.
...
/**
 * List of available Locales for the device.
...
/**
 * Provides information about the device operating system.
...
/**
 * Gets database reference object by given name.
...
/**
 * Creates a table inside the given database.
...
/**
 * Deletes table from the given database.
 * @param {Database} db The database object reference (as provided by {@link #GetDatabase} ).
...
/**
 * Gets table names from the given database.
...
/**
 * Checks if database exists by given database name (including .db extension).
...
/**
 * Creates a directory under the given base directory, or under root directory if it is not provided.
...
/**
 * Creates a file under the given base directory, or under root directory if it is not provided.
...
/**
 * List all directories under the given base directory data, or under root directory if it is not provided.
...
/**
 * List all files under the given base directory data, or under root directory if it is not provided.
...
/**
 * Gets the configured I/O services (the ones configured on the '/app/config/io-services-config.xml' file).
...
/**
 * Gets the orientation relative to the given north type (if 'northType' is not provided, default is used: magnetic noth pole).
 * @param {int} northType Type of north to measured orientation relative to it. Optional parameter.
...
/**
 * Moves a POI - given its id - to target location.
 * @param {String} poiId POI identifier.
 * @version 1.0
 */
 ...
 * @return MediaState Current player state.
 * @version 1.0
 */
...
/**
 * Gets the currently playing media file metadata.
...
/**
 * Opens user interface view to select a picture from the device photos album.
