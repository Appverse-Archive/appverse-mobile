...
AppverseEmulator = {
    ...
    simulateNetworkToOffline: function () {
        Appverse.Net.NetworkStatus = Appverse.Net.NETWORKTYPE_UNKNOWN;
        Appverse.Net.onConnectivityChange(Appverse.Net.NetworkStatus);
    },
    simulateNetworkToWifi: function () {
        Appverse.Net.NetworkStatus = Appverse.Net.NETWORKTYPE_WIFI;
        Appverse.Net.onConnectivityChange(Appverse.Net.NetworkStatus);
    },
    simulateNetworkToCarrier: function () {
        Appverse.Net.NetworkStatus = Appverse.Net.NETWORKTYPE_3G;
        Appverse.Net.onConnectivityChange(Appverse.Net.NetworkStatus);
    }
};
...
Appverse = {
    ...
    init: function () {
        ...
        if (Appverse.executingInEmulator) {
            ...
            if (Appverse.is.Android && !window.appverseJSBridge) {
                // use legacy server for older android versions
                Appverse.DOCUMENTS_RESOURCE_URI = 'http://127.0.0.1:' + LOCAL_SERVER_PORT + Appverse.DOCUMENTS_RESOURCE_URI;
                Appverse.MODULES_RESOURCE_URI = 'http://127.0.0.1:' + LOCAL_SERVER_PORT + Appverse.MODULES_RESOURCE_URI;
            } else {
				...
				// Windows Phone special DOCUMENTS_RESOURCE_URI
				if(Appverse.is.Windows) {
					Appverse.DOCUMENTS_RESOURCE_URI = "/DocumentsRootFolder/";
				}
            }
        }
        try {
            Appverse.MAIN_PAGE_RESOURCE_URI = location.href.split("/").splice(0, 5).join('/') + '/';
        } catch (e) {
            console.log('Error fetching main page URL');
        }
    },
    ...
    initAppverseContext: function () {
        ...
        if (Appverse.is.Tablet && !getQueryParam("deviceType"))
            location.href = location.origin + location.pathname + "?" + addQueryParam("deviceType", "Tablet") + location.hash
        else if (Appverse.is.Phone && getQueryParam("deviceType"))
            location.href = location.origin + location.pathname + "?" + removeQueryParam("deviceType") + location.hash
        ...
        if (typeof (this.is.Emulator) != "undefined" && this.is.Emulator == true) {
			...
			AppverseEmulator.normalizeListenerCallingName  = function(methodName) {
                ...
                if(methodName=="TakeSnapshotWithOptions") 	return "GetSnapshot";
                ...
                if(Appverse.Scanner) {  // that module could not be present (as per app configuration)
					if(methodName=="DetectQRCodeFront") 		return "DetectQRCode";
				}
            ...
            AppverseEmulator.eventListenersRegistered = AppverseEmulator.eventListenersRegistered.concat([
				...
				"GetSnapshot", "TakeSnapshot", "TakeSnapshotWithOptions",
				"UpdateModule", "UpdateModules",
				"GetStoredKeyValuePair", "GetStoredKeyValuePairs",
				"StoreKeyValuePair", "StoreKeyValuePairs",
				"RemoveStoredKeyValuePair", "RemoveStoredKeyValuePairs", "LaunchApplication", "LoadModule"]);

			if (Appverse.Scanner) { // that module could not be present (as per app configuration)
                AppverseEmulator.eventListenersRegistered.push("DetectQRCode");
                AppverseEmulator.eventListenersRegistered.push("DetectQRCodeFront");
                AppverseEmulator.eventListenersRegistered.push("GenerateQRCode");
            }
            ...
            if (Appverse.USPG) {
                AppverseEmulator.eventListenersRegistered.push("Activate");
                AppverseEmulator.eventListenersRegistered.push("Login");
                AppverseEmulator.eventListenersRegistered.push("CheckStatus");
                AppverseEmulator.eventListenersRegistered.push("PaymentAuth");
            }
...
if (typeof (APPVERSE_VERSION) != "undefined") {
    if (APPVERSE_VERSION != Appverse.version) {
...
Appverse.backgroundApplicationListener = function () {
    ...
    console.log('%c Override backgroundApplicationListener method! ', 'background: #222; color: #bada55');
  };
...
Appverse.foregroundApplicationListener = function () {
    console.log(arguments);
    console.log('%c Override foregroundApplicationListener method! ', 'background: #222; color: #bada55');
  };
...
Appverse.backButtonListener = function () {
    console.log(arguments);
    console.log('%c Override backButtonListener method! ', 'background: #222; color: #bada55');
  };
...
Appverse.OnLocalNotificationReceived = function (notificationData) {
    console.log(arguments);
    console.log('%c Override OnLocalNotificationReceived method! ', 'background: #222; color: #bada55');
  };


/**
 * Applications should override/implement this method to be aware when the keyboard is shown on Windows Phone devices.
 * @aside guide application_listeners
 * <br> @version 5.0
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/error.png"/> N/A | android <img src="resources/images/error.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
Appverse.OnWPKeyboardShow = function () {
    console.log(arguments);
    console.log('%c Override OnWPKeyboardShow method! ', 'background: #222; color: #bada55');

};

/**
 * Applications should override/implement this method to be aware when the keyboard is closed on Windows Phone devices.
 * @aside guide application_listeners
 * <br> @version 5.0
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/error.png"/> N/A | android <img src="resources/images/error.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
Appverse.OnWPKeyboardHide = function () {
    console.log(arguments);
    console.log('%c Override OnWPKeyboardHide method! ', 'background: #222; color: #bada55');
...
/**
 * Applications should override/implement this method to be aware of screenshot detection (user_did_take_screenshot event), and should perform the desired javascript code on this case.
 * @aside guide application_listeners
 * <br> @version 5.1.1
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> N/A | android <img src="resources/images/error.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 *
 */
Appverse.UserDidTakeScreenshot = function () {
    console.log(arguments);
    console.log('%c Override Appverse.UserDidTakeScreenshot method! ', 'background: #222; color: #bada55');
  };
...
/**
 * URI to access Web Resources of the current app.
 * <pre>DPlatform value: 'http://&lt;internal_server_host&gt;:&lt;internal_server_port&gt;/WebResources/www/'.</pre>
 * <br> @version 5.0.9
 * @type String
 */
Appverse.MAIN_PAGE_RESOURCE_URI = '/WebResources/www/';
...
Net = function () {
    ...
    this.onConnectivityChange = function (NetworkType) {
        console.log(arguments);
        console.log('%c Override onConnectivityChange method! ', 'background: #222; color: #bada55');
      };
}
...
System = function () {
    ...
    /**
     * A success type for LaunchApplication result
     * <br> @version 5.0.11
     * @type String
     */
    this.LAUNCH_APP_RESULT_SUCCESS = "SUCCESS";

    /**
     * A failure type for LaunchApplication result, indicating that there is some problem with the method call.
     * Probably, the app configured in the configuration file misses the current 'platform' node, or the app object passed is wrong.
     * <br> @version 5.0.11
     * @type String
     */
    this.LAUNCH_APP_RESULT_SYNTAX_ERROR = "METHOD_CALL_SYNTAX_ERROR";

    /**
     * A failure type for LaunchApplication result, indicating that there is no app that can handle this app configuration (URI scheme, component name, etc).
     * <br> @version 5.0.11
     * @type String
     */
    this.LAUNCH_APP_RESULT_NO_APP_AVAILABLE = "NO_APP_CAN_OPEN_URI_SCHEME";

    /**
     * A failure type for LaunchApplication result, indicating that the resource located by the given app configuration cannot be found or launched.
     * Please, review the app configuration in the configuration file for the current 'platform' node.
     * <br> @version 5.0.11
     * @type String
     */
    this.LAUNCH_APP_RESULT_NO_RESOURCE_AVAILABLE = "RESOURCE_CANNOT_BE_OPENED";

    /**
     * @event onLaunchApplicationResult Fired when the {@link Appverse.System.LaunchApplication LaunchApplication} method is called, in order to advise the app about the result of that app launching
     * <br>Method to be overrided by JS applications, to handle this event.
     * @aside guide application_listeners
     * <br> @version 5.0.11
     * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/error.png"/> </pre>
     * @param {Boolean} canOpen A boolean indicating if there is success (true) or failure (false) in that application launch.
     * @param {String} canOpenMessage A string that provides more information about the type of failure (not localized string, just raw information to be mapped to a localized literal in the app). Possible values: {@link Appverse.System#LAUNCH_APP_RESULT_SUCCESS LAUNCH_APP_RESULT_SUCCESS},{@link Appverse.System#LAUNCH_APP_RESULT_SYNTAX_ERROR LAUNCH_APP_RESULT_SYNTAX_ERROR},{@link Appverse.System#LAUNCH_APP_RESULT_NO_APP_AVAILABLE LAUNCH_APP_RESULT_NO_APP_AVAILABLE}, and {@link Appverse.System#RESOURCE_CANNOT_BE_OPENED RESOURCE_CANNOT_BE_OPENED}
     */
    this.onLaunchApplicationResult = function (canOpen, canOpenMessage) {
        console.log(arguments);
        console.log('%c Override onLaunchApplicationResult method! ', 'background: #222; color: #bada55');
      };
...
System.prototype.GetMemoryAvailable = function (memUse, memType, callbackFunctionName, callbackId) {
    if (memType == null) {
        post_to_url_async(Appverse.System.serviceName, "GetMemoryAvailable", get_params([memUse]), callbackFunctionName, callbackId);
    } else {
...
FileSystem.prototype.ListFiles = function (dirData, callbackFunctionName, callbackId) {
    if (dirData == null) {
        post_to_url_async(Appverse.FileSystem.serviceName, "ListFiles", null, callbackFunctionName, callbackId);
    } else {
...
IO = function () {
     ...
     * @type int
     */
    this.SERVICETYPE_MULTIPART_FORM_DATA = 10;
...
/**
 * Clears the native cookie container (in order to reset any previous cookie for any domain or end-point)
 * <br> @version 5.1.1
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
IO.prototype.ClearCookieContainer = function() {
	post_to_url_async(Appverse.IO.serviceName, "ClearCookieContainer", null, null, null);
};
...
Geo.prototype.GetPOIList = function (location, radius, queryText, category, callbackFunctionName, callbackId) {
    if (queryText == null && category == null) {
        post_to_url_async(Appverse.Geo.serviceName, "GetPOIList", get_params([location, radius]), callbackFunctionName, callbackId);
    } else if (queryText == null) {
        post_to_url_async(Appverse.Geo.serviceName, "GetPOIList", get_params([location, radius, category]), callbackFunctionName, callbackId);
    } else if (category == null) {
        post_to_url_async(Appverse.Geo.serviceName, "GetPOIList", get_params([location, radius, queryText]), callbackFunctionName, callbackId);
    } else post_to_url_async(Appverse.Geo.serviceName, "GetPOIList", get_params([location, radius, queryText, category]), callbackFunctionName, callbackId);
};
 ...
 * @param {String} callbackId The id to uniquely identify different callbacks with the same callback function. Defaults to "callbackid".
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/error.png"/> | windows <img src="resources/images/check.png"/> | emulator <img src="resources/images/check.png"/> *mock data</pre>
 */
...
Media = function () {
     ...
     * or from the Camera (after calling the {@link Appverse.Media.TakeSnapshot TakeSnapshot} or {@link Appverse.Media.TakeSnapshotWithOptions TakeSnapshotWithOptions})
     * <br>Method to be overrided by JS applications, to handle this event.
     * @aside guide application_listeners
     * <br> @version 3.1
 ...
 * <br> @version 5.0  - iOS and Android
 * <br> @version 5.1.1  - Windows Phone
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/check.png"/> | emulator <img src="resources/images/check.png"/> </pre>
 */
 ...
 * Opens user interface view to take a picture using the device camera.<br/>For further information see, {@link Appverse.Media.MediaMetadata MediaMetadata}.
 * Data is provided via the proper event handled by the "Appverse.Media.onFinishedPickingImage" method; please, override to handle the event.
 * <br> @version 5.0.12 - iOS and Android
 * <br> @version 5.1.1 - Windows Phone
 * @param {Appverse.Media.CameraOptions} cameraOptions Special camera options to be applied.
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/check.png"/> | emulator <img src="resources/images/warning.png"/> *in progress</pre>
 */
Media.prototype.TakeSnapshotWithOptions = function(cameraOptions)
{
    post_to_url_async(Appverse.Media.serviceName, "TakeSnapshotWithOptions", get_params([cameraOptions]), null, null);
};
...
/**
 * @ignore
 * Sends a multimedia message (MMS). NOT SUPPORTED BY ANY PLATFORM.
 * <br> @version 1.0. Modified version 4.5: this method is now asynchronous, but it has no callback function.
 * @param {String} phoneNumber The phone address to send the message to (also, multiple addresses separated by comma or semicolon).
 * @param {String} text The message body.
...
Pim = function () {
    ...
    this.onListContactsEnd = function (contacts) {
        console.log(arguments);
        console.log('%c Override onListContactsEnd method! ', 'background: #222; color: #bada55');
      };
    ...
    this.onContactFound = function (contact) {
        console.log(arguments);
        console.log('%c Override onContactFound method! ', 'background: #222; color: #bada55');
      };
...
Security = function () {
    ...
    this.onTouchIDNotAvailable = function () {
        console.log(arguments);
        console.log('%c Override onTouchIDNotAvailable method! ', 'background: #222; color: #bada55');
      };
    ...
    this.onLocalAuthenticationWithTouchIDReply = function (success, errorDescription) {
        console.log(arguments);
        console.log('%c Override onLocalAuthenticationWithTouchIDReply method! ', 'background: #222; color: #bada55');
      };


      /**
       * @event OnKeyValuePairsStoreCompleted Fired when storing of KeyPairs object into the local secure storage, and should perform the desired javascript code on this case.
       ...
       * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
       */
      this.OnKeyValuePairsStoreCompleted = function (storedKeyPairs, failedKeyPairs) {
          console.log(arguments);
          console.log('%c Override OnKeyValuePairsStoreCompleted method! ', 'background: #222; color: #bada55');
        };

      /**
       * @event OnKeyValuePairsFound Fired when KeyPair objects found in the device local secure storage, and should perform the desired javascript code on this case.
       * <br> For further information see, {@link Appverse.Security.KeyPair KeyPair}.
       * @aside guide application_listeners
       * <br> @version 5.1
       ...
       * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
       */
      this.OnKeyValuePairsFound = function (foundKeyPairs) {
          console.log(arguments);
          console.log('%c Override OnKeyValuePairsFound method! ', 'background: #222; color: #bada55');
        };


        /**
         * @event OnKeyValuePairsRemoveCompleted Fired when deletion of KeyPairs objects from the local secure storage, and should perform the desired javascript code on this case.
         * <br> For further information see, {@link Appverse.Security.KeyPair KeyPair}.
         * @aside guide application_listeners
         * <br> @version 5.1
         ...
         * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
         */
        this.OnKeyValuePairsRemoveCompleted = function (removedKeyPairs, failedKeyPairs) {
            console.log(arguments);
            console.log('%c Override OnKeyValuePairsRemoveCompleted method! ', 'background: #222; color: #bada55');
          };
}
 ...
 * <br> @version 5.0.8
 * <br> It returns a {Boolean} with a value of True if the device ROM is modified.
 * @param {String} callbackFunctionName The name of the callback function to be called when the method response is handled. Arguments of this function are the invocation result object and the invocation callbackId. Defaults to "callback".
 * @param {String} callbackId The id to uniquely identify different callbacks with the same callback function. Defaults to "callbackid".
 * @method
 * <pre> Available in: <br> iOS <img src="resources/images/error.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/> *mock data </pre>
 */
Security.prototype.IsROMModified = function (callbackFunctionName, callbackId) {
    post_to_url_async(Appverse.Security.serviceName, "IsROMModified", null, callbackFunctionName, callbackId);
};

/**
 * Adds or updates  - if already exists - a given key/value pair into the device local secure storage.
 * <br> Returned data should be handled by overriding the corresponding Platform Listeners {Appverse.Security.OnKeyValuePairsStoreCompleted}
 * <br> @version 5.0
 * @method
 ...
 * <br> Returned data should be handled by overriding the corresponding Platform Listeners {Appverse.Security.OnKeyValuePairsFound}
 * <br> @version 5.1
 * @method
 * @param {Appverse.Security.KeyPair} keyPair Name of the key to be returned
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
Security.prototype.GetStoredKeyValuePair = function (keyPair) {
    post_to_url_async(Appverse.Security.serviceName, "GetStoredKeyValuePair", get_params([keyPair]), null, null);
};
 ...
 * <br> @version 5.1
 * @method
 * @param {Appverse.Security.KeyPair[]} keyPairs Array of Strings containing the keys to be returned, Value could be null
 * <pre> Available in: <br> iOS <img src="resources/images/check.png"/> | android <img src="resources/images/check.png"/> | windows <img src="resources/images/error.png"/> | emulator <img src="resources/images/check.png"/></pre>
 */
Security.prototype.GetStoredKeyValuePairs = function (keyPairs) {
    post_to_url_async(Appverse.Security.serviceName, "GetStoredKeyValuePairs", get_params([keyPairs]), null, null);
};

/**
 *	Removes - if already exists - a given key/value pair from the device local secure storage
 * <br> Returned data should be handled by overriding the corresponding Platform Listeners {Appverse.Security.OnKeyValuePairsRemoveCompleted}
 * <br> @version 4.2
 * @method
...
AppLoader = function () {
    ...
    this.onUpdateModulesFinished = function (successUpdates, failedUpdates, callbackId) {
        console.log(arguments);
        console.log('%c Override onUpdateModulesFinished method! ', 'background: #222; color: #bada55');
      };
    ...
    this.onDeleteModulesFinished = function (successDeletes, failedDeletes) {
        console.log(arguments);
        console.log('%c Override onDeleteModulesFinished method! ', 'background: #222; color: #bada55');
      };
}
...
AppLoader.prototype.LoadModule = function (module, parameters, autoUpdate) {
    if (autoUpdate == null) post_to_url_async(Appverse.AppLoader.serviceName, "LoadModule", get_params([module, parameters]), null, null);
    else post_to_url_async(Appverse.AppLoader.serviceName, "LoadModule", get_params([module, parameters, autoUpdate]), null, null);
};

/**
 * Loads a Preview inside the Appverse WebResources Container (WebView). All modules should include an 'index.html' file as the main HTML file (entry point).
 * <br> @version 5.0.12
 * @param {Appverse.AppLoader.Module} module The module to be loaded.
 * @param {Appverse.AppLoader.ModuleParam[]} parameters The parameters to be added to the module main HTML file request; as GET request parameters (optional field, null for not including any parameter).
 * @param {Boolean} autoUpdate True to upload the module (using the corresponding LoadUrl and Version) prior to load it. Optional parameter. False is the default value. The update would be "silent", no event listener will be called by the platform in this case.
 * @method
 */
AppLoader.prototype.LoadPreview = function(module, parameters, autoUpdate)
{
    post_to_url_async(Appverse.AppLoader.serviceName, "LoadPreview", get_params([module, parameters, autoUpdate]), null, null);
};
 ...
 */
window.getQueryParam = function getQueryParam(param) {
    var found;
...
window.removeQueryParam = function removeQueryParam(parameter) {
...
window.addQueryParam = function addQueryParam(key, value) {
    key = encodeURI(key);
    ...
    if (kvp.length == 1) return kvp[0];
    else return kvp.join('&');
}
 ...
 *
 */
Appverse.executingInEmulator = true; Appverse.is = {"Android":false, "iOS":true, "Phone":true, "Tablet":false};  Appverse.init();
