...
namespace WindowsPhoneSDKLibs
{
    ...
    public sealed partial class PinSet : Page
    {
        ...
        public PinSet()
        {
            ...
            //#if INFOCERT
			/*
            this.Background = pinSet.Foreground = pinSetConfirm.Foreground = new SolidColorBrush(Color.FromArgb(255, 0, 74, 140));
            pinSet.Background = pinSetConfirm.Background = this.btnOK.Foreground = new SolidColorBrush(Colors.White);
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                userAdvise.Text = "Pin field can not be empty.";
            }
            ...
            {
                userAdvise.Text = "Pins don't match";
            }
        }
